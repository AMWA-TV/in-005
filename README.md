...
- Defines principles for ingressing external media Signals into a Dynamic Media Facility (DMF) Media Workload and conforming them into usable, time-aligned Flows.
...
- External Signals may have different clock frequency and timestamp provenance, so consistent ingress conformance is needed to align media Flows and support interoperable processing.
- Clear conformance principles help avoid unnecessary buffering and make timing adjustments traceable.

### How does it work?

- Uses Signal frequency and timestamp provenance, together with the Media Workload clock, to determine how Indexing Time Stamps (as defined in [AMWA IN-002: Time and Identity in the Dynamic Media Facility]([https://specs.amwa.tv/in-index](https://github.com/AMWA-TV/in-002)) are created or adjusted.
